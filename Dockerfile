FROM alpine:3.18
LABEL description="Wireguard VPN" org.opencontainers.image.authors="github.com/kybix"

MAINTAINER kybix <kybix555@gmail.com>
...
# Copy tools
WORKDIR /srv
COPY start restart addclient addcl clientcontrol /srv/
